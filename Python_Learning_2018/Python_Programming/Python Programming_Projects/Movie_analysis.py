...
a_array = np.array([movie_days_count, movie_money_count, movie_people_watching_count,movie_rank_count,movie_rates_count])
...
WC = wordcloud.WordCloud(font_path = 'C:\\Windows\\Fonts\\msyh.ttc',max_words=2000,mask = MASK,height= 400,width=400,background_color='white',repeat=False,mode='RGBA') 
